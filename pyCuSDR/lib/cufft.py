...
# Copyright (c) 2021 Edwin G. W. Peters. All rights reserved.

"""
Python interface to CUFFT functions. 
Borrowed from scikit-cuda (https://github.com/lebedov/scikit-cuda) with fftW compatibility mode removed
