...
# Title: blade loopback
# Author: Edwin G. W. Peters
# Copyright: Edwin G. W. Peters
# Description: Loopback example with the bladeRF
...
class blade_graph(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "blade loopback")
        Qt.QWidget.__init__(self)
        self.setWindowTitle("blade loopback")
        ...
        self.settings = Qt.QSettings("GNU Radio", "blade_graph")
        ...
        self.osmosdr_source_0 = osmosdr.source(
            args="numchan=" + str(1) + " " + "bladerf=0,agc_mode='manual'"
        )
        self.osmosdr_source_0.set_time_unknown_pps(osmosdr.time_spec_t())
        self.osmosdr_source_0.set_sample_rate(samp_rate)
        self.osmosdr_source_0.set_center_freq(Fc_Hz-F_offset_Hz, 0)
        ...
        self.osmosdr_sink_0.set_center_freq(Fc_Hz-F_offset_Hz+freq_offset_Hz, 0)
    ...
    def set_freq_offset_Hz(self, freq_offset_Hz):
        ...
        self.osmosdr_sink_0.set_center_freq(self.Fc_Hz-self.F_offset_Hz+self.freq_offset_Hz, 0)
    ...
    def set_Fc_Hz(self, Fc_Hz):
        self.Fc_Hz = Fc_Hz
        self.osmosdr_sink_0.set_center_freq(self.Fc_Hz-self.F_offset_Hz+self.freq_offset_Hz, 0)
        self.osmosdr_source_0.set_center_freq(self.Fc_Hz-self.F_offset_Hz, 0)
...
def main(top_block_cls=blade_graph, options=None):
