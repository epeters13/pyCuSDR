...
from protocol.GFSK2_base import *
...
class Bench_GFSK(Bench_base,GFSK2):
    """
    A class to benchmark GSK2 performance
    ...
    def get_filter(self,Nfft,spSym,maskSize):
        ...
        # self._weight_filters(filters) # Probably not needed since there is no ISI
